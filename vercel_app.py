    ...
    try:
        ...
        if db_word:
            data = {
                ...
                'turkumi': [cat.category for cat in db_word.categories.all()],
                'синонимы': [syn.related_word for syn in db_word.synonyms.all()],
                'антонимы': [ant.related_word for ant in db_word.antonyms.all()],
                'гиперонимы': [hyp.related_word for hyp in db_word.hyperonyms.all()],
                'гипонимы': [hypo.related_word for hypo in db_word.hyponyms.all()],
                'xolonim': [hol.related_word for hol in db_word.holonyms.all()],
                'meronim': [mer.related_word for mer in db_word.meronyms.all()],
                'omonim': [hom.related_word for hom in db_word.homonyms.all()],
                'paronim': [par.related_word for par in db_word.paronyms.all()],
                'qollanilishi': [area.area for area in db_word.usage_areas.all()],
